    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            if(!video.file || !thumbnail.file) {
                setError("Please upload  video or thumbnail files.");
                return;
            }
    ...
    return (
        <div className='wrapper-md upload-page'>
            ...
            <form className='rounded-20 shadow-10 gap-6 w-full flex flex-col px-5 py-7.5'>
                ...
                <FormField id="description" label="Description" placeholder="Describt what this video is about" value={formData.description} onChange={handleInputChange} as="textarea"/>
                ...
                <button type="submit"  className='submit-button' onSubmit={handleSubmit}>{isSubmitting ? "Uploading ..." : "Upload video"}</button>          
            </form>
        </div>
    )
}
